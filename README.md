...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
    -Relational databases are stored data in rows and columns.
    -SQL is what manges the databases.

- [ ] Why do tables need a `primary key`?
    Every table requires a primary key to identify each entry uniguely.
...
- [ ] What do we need in order to have a _many to many_ relationship between two tables.
  You have to have a connecting table with reference to their Ids
